...
substituting the known gaussian conditionals into equation (1). For those interested, a full derivation 
is presented in the appendix of [[8]](#citation-8).
...
$$
  L_{t-1} = \mathbb{E}_{t,x_t,x0} \left[ \frac{1}{2\sigma_t^2} \lVert \tilde{\mu}_t(x_t,x_0) - \mu_{\theta}(x_t, t) \rVert \right] + C
$$

As it is written here, this objective is suitable for training. However, Ho et al. propose a different parameterisation
that seems to provide better empircal results.
