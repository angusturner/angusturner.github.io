...
$$
  ...
  \left( x_t(x_0, \epsilon) - \frac{\beta_t}{\sqrt{1 - \bar{\alpha}_t}} \epsilon_{\theta}(x_t, t) \right) \tag{8}
$$
...
$$
  ...
  \left( \epsilon - \epsilon_{\theta}(x_t, t) \right) \right\rVert \right] + C\\
$$
$$
  = \mathbb{E}_{x_0,\epsilon,t} \left[ \frac{\beta_t^2}{2\sigma_t^2 \alpha_t (1 - \bar{\alpha}_t)} \left\lVert 
   \epsilon - \epsilon_{\theta}(x_t, t) \right\rVert \right] + C \tag{9}
$$
